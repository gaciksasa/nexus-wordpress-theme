	...
	private function get_preset_colors( $preset ) {
		$presets = array(
			'minimal-row'     => array(
				...
				'icon'       => nexus_palette()['secondary'],
				'number'     => nexus_palette()['primary'],
				'prefix_sfx' => nexus_palette()['secondary'],
				'title'      => '#6c757d',
				'desc'       => '#adb5bd',
			...
			'icon-cards'      => array(
				...
				'number'     => nexus_palette()['primary'],
				'prefix_sfx' => nexus_palette()['primary'],
				'title'      => '#6c757d',
				'desc'       => '#adb5bd',
				'card_bg'    => '#ffffff',
				'divider'    => 'transparent',
			...
			'accent-top'      => array(
				...
				'accent'     => nexus_palette()['secondary'],
			),
			'circle-icon'     => array(
				'section_bg' => '#ffffff',
				'icon'       => nexus_palette()['secondary'],
