...
class Nexus_Widget_Testimonials extends \Elementor\Widget_Base {
	...
	protected function render() {
		...
		(function(){
			...
			if(window.elementorFrontend){jQuery(window).on('elementor/frontend/init',function(){elementorFrontend.hooks.addAction('frontend/element_ready/nexus-testimonials.default',initTS);});}
		})();
		</script>
