...
class Nexus_Widget_Blog_Cards extends \Elementor\Widget_Base {
	...
	private function get_button_inline_style( $style ) {
		...
		$styles = array(
			'ghost-accent'  => $base . 'color:#e94560;padding:0;border:none;background:transparent;',
			'ghost-white'   => $base . 'color:#ffffff;padding:0;border:none;background:transparent;',
			'ghost-dark'    => $base . 'color:#1a1a2e;padding:0;border:none;background:transparent;',
			'outline'       => $btn . 'background-color:transparent;color:#e94560;border-color:#e94560;',
			'outline-dark'  => $btn . 'background-color:transparent;color:#1a1a2e;border-color:#1a1a2e;',
